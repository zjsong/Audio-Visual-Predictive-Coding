...
class VGGFC(nn.Module):
    def __init__(self, original_vgg, fc_vis=16):
        super(VGGFC, self).__init__()

        # use vgg16/19 architecture before the avgpool layer, i.e., all convolutional layers
        self.features = nn.Sequential(*list(original_vgg.children())[:-2])
