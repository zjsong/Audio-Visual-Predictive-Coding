...
class ArgParser(object):
    def __init__(self):
        ...
        parser.add_argument('--num_mix_train_pt', default=3, type=int,
                            help="number of sounds to mix at pre-training stage")
        parser.add_argument('--num_mix_train_ft', default=2, type=int,
                            help="number of sounds to mix at fine-tuning stage")
        parser.add_argument('--num_mix_eval', default=2, type=int,
                            help="number of sounds to mix at evaluation stage")
        ...
        parser.add_argument('--weights_frame', default='',
                            help="weights to fine-tune net_frame")
        parser.add_argument('--weights_sound', default='',
                            help="weights to fine-tune net_sound")
        parser.add_argument('--weights_simsiam', default='',
                            help="weights to fine-tune net_simsiam")
        parser.add_argument('--in_dim_projector', default=1 * 64 * 64, type=int,
                            help='input dimension of projector in SimSiam')
        ...
        parser.add_argument('--frameRate', default=8, type=float,
                            help='video frame sampling rate (fps)')
        ...
        parser.add_argument('--num_epoch_pt', default=40, type=int,
                            help='epochs to pre-training')
        parser.add_argument('--lr_frame_pt', default=1e-4, type=float, help='LR')
        parser.add_argument('--lr_sound_pt', default=1e-3, type=float, help='LR')
        parser.add_argument('--lr_simsiam', default=1e-3, type=float, help='LR')
        parser.add_argument('--lr_steps_pt', nargs='+', type=int, default=[20, 30],
                            help='steps to drop LR in epochs during pre-training')
        parser.add_argument('--num_epoch_ft', default=100, type=int,
                            help='epochs to fine-tuning')
        parser.add_argument('--lr_frame_ft', default=1e-4, type=float, help='LR')
        parser.add_argument('--lr_sound_ft', default=1e-3, type=float, help='LR')
        parser.add_argument('--lr_steps_ft', nargs='+', type=int, default=[40, 80],
                            help='steps to drop LR in epochs during fine-tuning')
